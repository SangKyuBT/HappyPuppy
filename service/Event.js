/*
 ...
 S3 delete
*/
const sharp = require('sharp'); //이미지 추출/리사이징
const {practice} = require('../modules/S3'); //S3 접속 및 동작 모듈
const fs = require('fs'); //파일 시스템
const DAM = require('../DAM/Event'); //데이터베이스 엑세스 모듈
...
const service = {
    ...
    */
    ...
    /*
     DB select, start와 end 사이기간에 있는 행사 정보 요청
